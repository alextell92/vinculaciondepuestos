...
definicionListaResponsabilidad():void{
  ...
  [
   ...
   {
    'value':2,
    'descripcion':"GRADO 2: MEDIA: RESPONSABILIDAD POR SU PUESTO Y SU FALTA IMPACTA EN EL DEPARTAMENTO DE MANTENIMIENTO"
   },
   {
    'value':3,
    'descripcion':"GRADO 3:ALTA:  SUPERVISIÓN DE TODO EL ÁREA DE MANTENIMIENTO Y SU FALTA IMPACTA A LA EMPRESA"
   }
]
